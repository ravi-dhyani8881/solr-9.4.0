...
define('css!panels/heatmap/module.css', ['css-embed'], 
function(embed)
{
	embed(
	'svg ::selection{background:transparent}svg ::-moz-selection{background:transparent}svg ::-webkit-selection{background:transparent}rect.selection{stroke:#333;stroke-dasharray:4px;stroke-opacity:.5;fill:transparent}rect.cell-border{stroke:#eee;stroke-width:.3px}rect.cell-selected{stroke:#369;stroke-width:.5px}rect.cell-hover{stroke:red;stroke-width:.3px}text.text-selected{fill:#000}text.text-highlight{fill:#c00}text.text-hover{fill:#00C}g>text{font-size:12px}.popup{position:absolute;width:200px;height:auto;padding:10px;background-color:#fff;-webkit-border-radius:10px;-moz-border-radius:10px;border-radius:10px;-webkit-box-shadow:4px 4px 10px rgba(0,0,0,.4);-moz-box-shadow:4px 4px 10px rgba(0,0,0,.4);box-shadow:4px 4px 10px rgba(0,0,0,.4);pointer-events:none;z-index:10000}.popup.hidden{display:none}.popup p{margin:0;font-family:sans-serif;font-size:12px;line-height:20px}.tick{stroke:#C8C8C8}.grid{stroke:#C8C8C8;stroke-dasharray:1,1}'
	);
	return true;
});
